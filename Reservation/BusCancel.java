		  ...
		  public void actionPerformed(ActionEvent e)
		  {
			...
			try {
				...
				//System.out.println(b.tail);
				   int result = JOptionPane.showConfirmDialog(new JFrame(), "Are you sure you want to cancel?",
				...
				JOptionPane.showMessageDialog(new JFrame(), "cancelling completed!", "Cancelling completed",
